...
public class Account_Node {
    ...
    public Account_Node(String accountName, int accountImage, String passwordReminder, String memonic, String keystore, String privateKey, String addressHexString, String accountMoney) {
        this.accountName = accountName;
        this.accountImage = accountImage;
        this.passwordReminder = passwordReminder;
        this.memonic = memonic;
